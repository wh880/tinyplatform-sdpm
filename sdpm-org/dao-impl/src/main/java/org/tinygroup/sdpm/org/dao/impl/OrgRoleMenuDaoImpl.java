...
public class OrgRoleMenuDaoImpl extends TinyDslDaoSupport implements OrgRoleMenuDao {
    ...
    public OrgRoleMenu getByMenuId(String id) {
        return getDslTemplate().getByKey(id, OrgRoleMenu.class, new SelectGenerateCallback<Serializable>() {
            @SuppressWarnings("rawtypes")
            public Select generate(Serializable t) {
    ...
    public List<OrgRoleMenu> getByRoleId(Integer roleId) {
