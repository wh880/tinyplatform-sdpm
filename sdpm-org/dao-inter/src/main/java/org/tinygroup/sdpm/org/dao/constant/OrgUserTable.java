...
public class OrgUserTable extends Table {
    ...
    public Map<String, KeyGenerator> getGeneratorMap() {
        HashMap<String, KeyGenerator> generatorHashMap = new HashMap<String, KeyGenerator>();
        generatorHashMap.put(ORG_USERTABLE.ORG_USER_ID.getColumnName(), new StringIdGenerator());
        return generatorHashMap;
    }
