...
public class ServiceRequestDaoImpl extends TinyDslDaoSupport implements ServiceRequestDao {
    ...
    public Pager<ServiceRequest> queryPagerBy(int start, int limit, ServiceRequest serviceRequest, final Integer statues, final Integer treeId, final OrderBy... orderArgs) {
        if (serviceRequest == null) {
            serviceRequest = new ServiceRequest();
        }
        if (treeId != null) {
