...
public class StoryUtil {
    public static String getStatusCondition(String choose){
        ...
        switch (Integer.valueOf(choose)){
            ...
            case 2:return "";
            case 3:return "story_assignedTo= '"+ UserUtils.getUserId()+"' ";
            case 4:return "story_openedBy= '"+ UserUtils.getUserId()+"' ";
            case 5:return "story_reviewedBy= '"+ UserUtils.getUserId()+"' ";
            case 6:return "story_closedBy= '"+ UserUtils.getUserId()+"' ";
