		...
		return getDslTemplate().insertAndReturnKey(qualityTestCase, new InsertGenerateCallback<QualityTestCase>() {
			public Insert generate(QualityTestCase t) {
				Insert insert = insertInto(QUALITY_TESTCASETABLE).values(
					...
					QUALITY_TESTCASETABLE.CASE_SCRIPTED_BY.value(t.getCaseScriptedBy()),
					QUALITY_TESTCASETABLE.CASE_SCRIPTED_DATE.value(t.getCaseScriptedDate()),
					QUALITY_TESTCASETABLE.SCRIPT_STATUS.value(t.getScriptStatus()),
					QUALITY_TESTCASETABLE.SCRIPT_LOCATION.value(t.getScriptLocation()),
					...
					QUALITY_TESTCASETABLE.CASE_OPENED_BY.value(t.getCaseOpenedBy()),
					QUALITY_TESTCASETABLE.CASE_OPENED_DATE.value(t.getCaseOpenedDate()),
					QUALITY_TESTCASETABLE.CASE_LAST_EDITED_BY.value(t.getCaseLastEditedBy()),
					QUALITY_TESTCASETABLE.CASE_LAST_EDITED_DATE.value(t.getCaseLastEditedDate()),
					QUALITY_TESTCASETABLE.CASE_VERSION.value(t.getCaseVersion()),
					QUALITY_TESTCASETABLE.LINK_CASE.value(t.getLinkCase()),
					QUALITY_TESTCASETABLE.CASE_FROM_BUG.value(t.getCaseFromBug()),
					QUALITY_TESTCASETABLE.DELETED.value(t.getDeleted()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUNNER.value(t.getCaseLastRunner()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_DATE.value(t.getCaseLastRunDate()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_RESULT.value(t.getCaseLastRunResult()));
				return insert;
			}
		});
	}
		...
		return getDslTemplate().update(qualityTestCase, new UpdateGenerateCallback<QualityTestCase>() {
			public Update generate(QualityTestCase t) {
				Update update = update(QUALITY_TESTCASETABLE).set(
					...
					QUALITY_TESTCASETABLE.CASE_LAST_RUNNER.value(t.getCaseLastRunner()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_DATE.value(t.getCaseLastRunDate()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_RESULT.value(t.getCaseLastRunResult())).where(
		...
		return getDslTemplate().query(qualityTestCase, new SelectGenerateCallback<QualityTestCase>() {
			...
			public Select generate(QualityTestCase t) {
				...
				and(
					...
					QUALITY_TESTCASETABLE.CASE_SCRIPTED_BY.eq(t.getCaseScriptedBy()),
					QUALITY_TESTCASETABLE.CASE_SCRIPTED_DATE.eq(t.getCaseScriptedDate()),
					QUALITY_TESTCASETABLE.SCRIPT_STATUS.eq(t.getScriptStatus()),
					QUALITY_TESTCASETABLE.SCRIPT_LOCATION.eq(t.getScriptLocation()),
					...
					QUALITY_TESTCASETABLE.CASE_OPENED_BY.eq(t.getCaseOpenedBy()),
					QUALITY_TESTCASETABLE.CASE_OPENED_DATE.eq(t.getCaseOpenedDate()),
					QUALITY_TESTCASETABLE.CASE_LAST_EDITED_BY.eq(t.getCaseLastEditedBy()),
					QUALITY_TESTCASETABLE.CASE_LAST_EDITED_DATE.eq(t.getCaseLastEditedDate()),
					QUALITY_TESTCASETABLE.CASE_VERSION.eq(t.getCaseVersion()),
					QUALITY_TESTCASETABLE.LINK_CASE.eq(t.getLinkCase()),
					QUALITY_TESTCASETABLE.CASE_FROM_BUG.eq(t.getCaseFromBug()),
					QUALITY_TESTCASETABLE.DELETED.eq(t.getDeleted()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUNNER.eq(t.getCaseLastRunner()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_DATE.eq(t.getCaseLastRunDate()),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_RESULT.eq(t.getCaseLastRunResult())));
		...
		return getDslTemplate().batchInsert(autoGeneratedKeys, qualityTestCases, new NoParamInsertGenerateCallback() {
			...
			public Insert generate() {
				return insertInto(QUALITY_TESTCASETABLE).values(
					...
					QUALITY_TESTCASETABLE.CASE_SCRIPTED_BY.value(new JdbcNamedParameter("caseScriptedBy")),
					QUALITY_TESTCASETABLE.CASE_SCRIPTED_DATE.value(new JdbcNamedParameter("caseScriptedDate")),
					QUALITY_TESTCASETABLE.SCRIPT_STATUS.value(new JdbcNamedParameter("scriptStatus")),
					QUALITY_TESTCASETABLE.SCRIPT_LOCATION.value(new JdbcNamedParameter("scriptLocation")),
					...
					QUALITY_TESTCASETABLE.CASE_OPENED_BY.value(new JdbcNamedParameter("caseOpenedBy")),
					QUALITY_TESTCASETABLE.CASE_OPENED_DATE.value(new JdbcNamedParameter("caseOpenedDate")),
					QUALITY_TESTCASETABLE.CASE_LAST_EDITED_BY.value(new JdbcNamedParameter("caseLastEditedBy")),
					QUALITY_TESTCASETABLE.CASE_LAST_EDITED_DATE.value(new JdbcNamedParameter("caseLastEditedDate")),
					...
					QUALITY_TESTCASETABLE.CASE_FROM_BUG.value(new JdbcNamedParameter("caseFromBug")),
					QUALITY_TESTCASETABLE.DELETED.value(new JdbcNamedParameter("deleted")),
					QUALITY_TESTCASETABLE.CASE_LAST_RUNNER.value(new JdbcNamedParameter("caseLastRunner")),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_DATE.value(new JdbcNamedParameter("caseLastRunDate")),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_RESULT.value(new JdbcNamedParameter("caseLastRunResult")));
			}
		});
	}
		...
		return getDslTemplate().batchUpdate(qualityTestCases, new NoParamUpdateGenerateCallback() {
			...
			public Update generate() {
				return update(QUALITY_TESTCASETABLE).set(
					...
					QUALITY_TESTCASETABLE.CASE_LAST_RUNNER.value(new JdbcNamedParameter("caseLastRunner")),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_DATE.value(new JdbcNamedParameter("caseLastRunDate")),
					QUALITY_TESTCASETABLE.CASE_LAST_RUN_RESULT.value(new JdbcNamedParameter("caseLastRunResult"))).where(
	...
	public int[] batchDelete(List<QualityTestCase> qualityTestCases) {
		...
		return getDslTemplate().batchDelete(qualityTestCases, new NoParamDeleteGenerateCallback() {
			...
			public Delete generate() {
				...
				QUALITY_TESTCASETABLE.CASE_SCRIPTED_BY.eq(new JdbcNamedParameter("caseScriptedBy")),
				QUALITY_TESTCASETABLE.CASE_SCRIPTED_DATE.eq(new JdbcNamedParameter("caseScriptedDate")),
				QUALITY_TESTCASETABLE.SCRIPT_STATUS.eq(new JdbcNamedParameter("scriptStatus")),
				QUALITY_TESTCASETABLE.SCRIPT_LOCATION.eq(new JdbcNamedParameter("scriptLocation")),
				...
				QUALITY_TESTCASETABLE.CASE_OPENED_BY.eq(new JdbcNamedParameter("caseOpenedBy")),
				QUALITY_TESTCASETABLE.CASE_OPENED_DATE.eq(new JdbcNamedParameter("caseOpenedDate")),
				QUALITY_TESTCASETABLE.CASE_LAST_EDITED_BY.eq(new JdbcNamedParameter("caseLastEditedBy")),
				QUALITY_TESTCASETABLE.CASE_LAST_EDITED_DATE.eq(new JdbcNamedParameter("caseLastEditedDate")),
				...
				QUALITY_TESTCASETABLE.CASE_FROM_BUG.eq(new JdbcNamedParameter("caseFromBug")),
				QUALITY_TESTCASETABLE.DELETED.eq(new JdbcNamedParameter("deleted")),
				QUALITY_TESTCASETABLE.CASE_LAST_RUNNER.eq(new JdbcNamedParameter("caseLastRunner")),
				QUALITY_TESTCASETABLE.CASE_LAST_RUN_DATE.eq(new JdbcNamedParameter("caseLastRunDate")),
				QUALITY_TESTCASETABLE.CASE_LAST_RUN_RESULT.eq(new JdbcNamedParameter("caseLastRunResult"))));
			}
		});
	}
