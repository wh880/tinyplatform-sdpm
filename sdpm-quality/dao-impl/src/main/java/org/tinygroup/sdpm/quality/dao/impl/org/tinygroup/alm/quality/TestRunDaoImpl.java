...
import static org.tinygroup.sdpm.quality.dao.org.tinygroup.alm.quality.constant.TestRunTable.*;
...
import org.tinygroup.sdpm.quality.dao.org.tinygroup.alm.quality.pojo.TestRun;
import org.tinygroup.sdpm.quality.dao.org.tinygroup.alm.quality.TestRunDao;
...
public class TestRunDaoImpl extends TinyDslDaoSupport implements TestRunDao {
	...
	public List<TestRun> query(TestRun testRun) {
		if(testRun==null){
			testRun=new TestRun();
		}
	...
	public Pager<TestRun> queryPager(int start,int limit ,TestRun testRun) {
		if(testRun==null){
			testRun=new TestRun();
		}
