...
import static sdpm.product.dao.inter.dao.constant.ProductTable.*;
...
import sdpm.product.dao.inter.dao.inter.ProductDao;
import sdpm.product.dao.inter.dao.pojo.Product;
...
public class ProductDaoImpl extends TinyDslDaoSupport implements ProductDao {
	...
	public Pager<Product> queryPager(int start,int limit ,Product product) {
		if(product==null){
			product=new Product();
		}
